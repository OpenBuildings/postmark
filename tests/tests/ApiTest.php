...
class ApiTest extends PHPUnit_Framework_TestCase {
	...
	public function test_send_wrong_email()
	{
		...
		$this->setExpectedException('Exception', "Postmark delivery failed: Error parsing 'To': Illegal email domain 'example.com>' in address 'Jimmy Kenno <test_email@example.com>'");
